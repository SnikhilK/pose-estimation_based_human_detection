...
def visualize(
  ...
  for person in list_persons:
    ...
    if bounding_box is not None:
      ...
      #cv2.circle(image, (start_point), 5, (255,255,0), -1)
      #cv2.circle(image, (end_point), 5, (0,255,255), -1)
      ...
      x_centroid = int((end_point[0] - start_point[0]) / 2 + start_point[0])
      print(x_centroid)
      cv2.line(image, (x_centroid,0),(x_centroid,480), (255,255,255), 3) 
      if (272 <= x_centroid <= 400):
          ser.write(b"center\n")
          print("Centered")
      elif (x_centroid<128):
          ser.write(b"left\n")
          print("Turn Left")
      elif (128 <= x_centroid < 272):
          ser.write(b"left5\n")
          print("Turn Left 0.5")
      elif (400 < x_centroid <= 512):
          ser.write(b"right5\n")
          print("Turn Right 0.5")
      elif (x_centroid>512.0):
          ser.write(b"right\n")
          print("Turn Right")
